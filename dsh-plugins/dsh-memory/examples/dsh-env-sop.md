...
- 已装自定义插件: dsh-vision-skill（识图 8 工具）+ dsh-memory（记忆 v0.4，命名空间/自动蒸馏/自动维护）
...
- 插件开发目录: `<Agent_Extensions>\dsh-plugins\{dsh-vision-skill,dsh-memory}`（发布仓库同目录，GitHub: DDDFXYqiming/Agent_Extensions）
